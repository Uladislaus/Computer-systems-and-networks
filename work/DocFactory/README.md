...
| **Мои шаблоны** | свои формы: вкладка **«Мои шаблоны»** — конструктор полей, сохранение в `user_templates/`, заполнение как у обычных шаблонов |

### Быстрый «фокус» (F12)

Кнопка **Фокус F12** или **F12** / **Ctrl+Shift+H**: полноэкранная заставка в стиле IDE.  
**Всё крутится само** (набор кода, терминал, загрузки, метрики, лог сборки) — кликать и печатать не нужно.  
Выход: **Esc** или снова **F12**.
...
Свой шаблон: вкладка **Мои шаблоны** → название / заголовок / поля (шапка · раздел · подпись) → **Сохранить** → на вкладке **Шаблоны** выбрать «Мои шаблоны: …» и заполнить.
